  ...
  return (
    ...
    <footer className="bg-white font-sans ">
        <div className="container px-6 py-12 mx-auto">
            ...
            <p className="font-sans p-8 text-start md:text-center md:text-lg md:p-4">© {new Date().getFullYear()} - {
            parseInt(new Date().getFullYear())+1} RouteShare Inc. All rights reserved.</p>
        </div>
    </footer>
  );
};
