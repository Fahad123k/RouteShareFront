...
const SearchBar = () => {
  ...
  return (
    ...
    >
      {/* Leave From */}
      <div className="relative w-full sm:w-1/2 border-b border-gray-200">
        <div className="inline-flex items-center">
          ...
          <input
            type="text"
            className="rounded-r-md text-gray-900 block w-50 text-sm p-2.5"
        ...
        {isLeaveFromFocused && leaveFromSuggestions.length > 0 && (
          <div className="absolute left-[-10px] w-100 top-12 bg-white border border-gray-200 rounded-lg shadow-lg z-50 mt-1 max-h-48 overflow-y-auto p-1 m-2">
      ...
      {/* Going To */}
      <div className="relative flex items-center border-b border-gray-200 w-full sm:w-1/2">
          <span className="inline-flex items-center px-3 text-sm text-gray-900">
            <FaRegCircleDot className="text-xl" />
          </span>
          <input
          ...
          {isGoingToFocused && goingToSuggestions.length > 0 && (
            <div className="absolute left-10 top-12 w-100 bg-white border border-gray-200 rounded-md shadow-lg z-50 mt-1 max-h-48 overflow-y-auto">
