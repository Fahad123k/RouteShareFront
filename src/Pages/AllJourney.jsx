                    ...
                    travels.map((travel, index) => (
                        ...
                        >
                            ...
                            <div className="hidden sm:flex justify-between items-center border-b border-gray-300 p-4 relative ">
                                ...
                                <div className="flex-1 flex items-center justify-between ">
                                    <div className="flex-col w-full">
                                        ...
                                        <p className="font-bold text-gray-800">{travel.leaveFrom.city}</p>
                                    </div>
                                    <span className="w-full flex items-center m-2 ">
                                    ...
                                    <div className="flex-col">
                                        ...
                                        <p className="font-bold text-gray-800">{travel.goingTo.city}</p>
                                    </div>
                            ...
                            <div className="p-4 flex items-center space-x-4 ">
                                ...
                                <p className="text-gray-600">{travel.username.substring(0, 10)}</p>
